    ...
    <div class="container col-md-6" >
      <form action="hoatdong.php" method="POST"  enctype="multipart/form-data" style="background:#d5d1f6">
        <div class="row justify-content-around">
          <div class="col-7">         
            <legend class="w-100 p-3 fs-1 text-center">Cập Nhật Hoạt Động</legend>
              <?php include('message.php');?>
              <input type="hidden" name ="id_hd" value ="<?php echo $hd['id_hd']?>">
            <div class="mb-3">
                <label>Tên HD</label>
                <input type="text" name="TenHD" value="<?php echo $hd['ten_hd']?>" class="form-control">
            </div>
            
           <div class="mb-3">
            <label>Đơn vị</label>
                  <select class="form-select" name="DonVi" >
            ...
            <div class="mb-3">
              <label>Từ ngày</label>
              <input type="date" name="TuNgay" value="<?php echo $hd['den_ngay']?>" class="form-control">
            </div>
        
            <div class="mb-3">
              <label>Đến ngày</label>
              <input type="date" name="DenNgay" value="<?php echo $hd['den_ngay']?>" class="form-control">
            </div>
        
            <div class="mb-3">
              <label>Địa điểm</label>
              <input type="text" name="DiaDiem" value="<?php echo $hd['dia_diem']?>" class="form-control">
            </div>
          
            <div class="mb-3"> 
              <label>Nội dung</label>
              <textarea class="form-control" name="NoiDung"   style="height: 100px"><?php echo  $hd['noi_dung'];?></textarea>            
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <button type="submit" name="capnhatHD" class="btn btn-primary">Cập nhật</button>
                <a href="createHD.php" class="btn btn-primary">Trở về</a>
            </div>
          </div>
        </div> 
      </form>
